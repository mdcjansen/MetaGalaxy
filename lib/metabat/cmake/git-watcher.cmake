...
function(GitStateChangedAction _state_as_list)
    ...
    if (EXISTS "${POST_CONFIGURE_FILE}")
       if (NOT GIT_RETRIEVED_STATE) 
           set(SKIP_IT true)
           message("Skipping creation of ${POST_CONFIGURE_FILE} as git is not available")
       endif()
    endif()
    if (NOT SKIP_IT)
       message("Creating new ${POST_CONFIGURE_FILE} with ${GIT_RETRIEVED_STATE} ${TIMESTAMP}")
